...
{
    class NvParttime : ANv, INguoi
    {
        private int soGioLam;
        private float cong = 23000;


        public NvParttime():base()
        {
            
        }

        public NvParttime(NvParttime a)
        {
            this.maso = a.maso;
            this.hoten = a.hoten;
        ...
        public NvParttime(string maso, string hoten, DateTime ngaysinh, 
        string gioitinh, string sdt, string email, ChiNhanh cn) : base(maso, hoten, ngaysinh, gioitinh, sdt, email, cn)
        {
        }
        ...
        public void CapNhat()
        {
            ...
            {
                caLamTheoThang = new bool[4,31];
                thucLam = new bool [4,31];
                vang = 0;
                tangCa = 0;
            }
        }
        ...
        public int GioLam()
        {
            for (int i = 0; i<base.thucLam.GetLength(0); i++)
            for (int j = 0; j<base.thucLam.GetLength(1); j++)
            {
                if (thucLam[i, j] && caLamTheoThang[i,j])
                soGioLam+=6;
            }
            return soGioLam;
        }
        ...
        {
            caLamTheoThang = new bool[4,31];
            for (int i = caLamTheoThang.GetLowerBound(0); i<=caLamTheoThang.GetLowerBound(0); i++ )
            {
                for (int j = caLamTheoThang.GetLowerBound(1); j<=caLamTheoThang.GetLowerBound(1); j++ )
                {
        ...
        public override void ThucLam()
        {
            ...
            switch (DateTime.Now.Hour)
            {
                ...
                case 16: ca = 2; break;
                case 22: ca = 3; break;
                default: Console.WriteLine("error thucLam_P");
                return;
            }
        ...
        public override float TinhThuong()
        {
            ...
            return thuong = thuong + tangCa * 6 * cong;
        }

        public override float TinhPhat()
        {
            return Vang() * 6 *(cong + 12000);
        }

        public override float TinhLuong()
        {
            return GioLam() * cong + TinhThuong() - TinhPhat();
        }
